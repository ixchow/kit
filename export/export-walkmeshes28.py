...
if len(args) != 2:
	print("\n\nUsage:\nblender --background --python export-walkmeshes.py -- <infile.blend>[:collection] <outfile.w>\nExports the meshes referenced by all objects in collection to a binary blob, in walkmesh format, indexed by the names of the objects that reference them.\n")
	exit(1)
